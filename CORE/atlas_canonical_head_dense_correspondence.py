...
class AtlasCanonicalHeadDenseCorrespondence:
    correspondence_id: str
    topology: AtlasCanonicalHeadTopology
    observed_sample_to_canonical_vertex: Mapping[int, int]
    ...
    def __post_init__(self) -> None:
        ...
        mapping = self._normalize_mapping(
            self.observed_sample_to_canonical_vertex,
    ...
    def observed_sample_indices(
        ...
        return tuple(
            self.observed_sample_to_canonical_vertex.keys()
        )
    ...
    def canonical_vertex_indices(
        ...
        return tuple(
            self.observed_sample_to_canonical_vertex.values()
        )
    ...
    def canonical_vertex_index(
        ...
        return self.observed_sample_to_canonical_vertex[
    ...
    def _normalize_mapping(
        ...
        *,
        ...
        for observed_index, canonical_index in value.items():
