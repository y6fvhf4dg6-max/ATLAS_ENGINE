...
class AtlasWallCollectionTieredCornerSupportMesher:
    ...
    def build_universal_support(
        ...
        *,
        ...
        return {
            ...
            "total_height_mm": spec.total_height_mm,
            "bottom_connector": spec.bottom_connector,
            "top_connector": spec.top_connector,
            ...
            "connector_clearance_per_side_mm": (
                spec.connector_clearance_per_side_mm
            ),
    ...
    def _build_universal_local_triangles(
        ...
        *,
        ...
        main_wall_min = -clearance - wall
        main_wall_max = -clearance

        connector_pin_size = 3.0
        ...
        socket_outer_max = main_wall_min + 0.05
        socket_outer_min = (
            socket_outer_max - socket_outer_size
        )
        socket_inner_min = (
            socket_outer_min + socket_wall
        )
        socket_inner_max = (
            socket_outer_max - socket_wall
        )

        pin_center = (
            socket_outer_min + socket_outer_max
        ) / 2.0
        pin_min = pin_center - connector_pin_size / 2.0
        pin_max = pin_center + connector_pin_size / 2.0

        recess_top = spec.connector_recess_depth_mm
        socket_cap_top = recess_top + 1.2
        top_pad_bottom = total_height - 1.2
        male_top = (
            total_height
            + spec.connector_engagement_mm
        )
        ...
        boxes = (
            ...
            # Female socket walls at the lower outside diagonal.
            (
                socket_outer_min,
                socket_inner_min,
                socket_outer_min,
            ...
            # Upper pad attaches the male pin to the L body.
            (
                socket_outer_min,
                socket_outer_max,
                socket_outer_min,
