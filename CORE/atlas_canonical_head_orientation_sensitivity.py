...
class AtlasCanonicalHeadOrientationSensitivity:
    representation_id: str
    representation_kind: str
    orientation_id: str
    reference_orientation_id: str
    ...
    NON_OBSERVED_SENSITIVITY_STATES = (
        "UNRESOLVED",
        "NOT_OBSERVABLE",
    )
    ...
    def __post_init__(self) -> None:
        ...
        orientation_id = self._normalize_lower_identifier(
            self.orientation_id,
            field_name="orientation_id",
        )

        reference_orientation_id = self._normalize_lower_identifier(
            self.reference_orientation_id,
            field_name="reference_orientation_id",
        )
        ...
        if observation_state == "OBSERVED":
            if (
                sensitivity_state
                not in self.OBSERVED_SENSITIVITY_STATES
            ):
                raise ValueError(
