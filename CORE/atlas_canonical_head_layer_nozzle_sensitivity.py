...
class AtlasCanonicalHeadLayerNozzleSensitivity:
    representation_id: str
    representation_kind: str
    reference_nozzle_diameter_mm: float
    reference_layer_height_mm: float
    evaluated_nozzle_diameter_mm: float
    evaluated_layer_height_mm: float
    ...
    def __post_init__(self) -> None:
        ...
        reference_nozzle_diameter_mm = self._positive_finite(
            self.reference_nozzle_diameter_mm,
            field_name="reference_nozzle_diameter_mm",
        )

        reference_layer_height_mm = self._positive_finite(
            self.reference_layer_height_mm,
            field_name="reference_layer_height_mm",
        )

        evaluated_nozzle_diameter_mm = self._positive_finite(
            self.evaluated_nozzle_diameter_mm,
            field_name="evaluated_nozzle_diameter_mm",
        )

        evaluated_layer_height_mm = self._positive_finite(
            self.evaluated_layer_height_mm,
            field_name="evaluated_layer_height_mm",
        )
