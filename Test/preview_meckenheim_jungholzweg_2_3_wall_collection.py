...
PBF_PATH = "Data/OSM/meckenheim-jungholzweg-2-3-test.osm.pbf"
...
def build_parser() -> argparse.ArgumentParser:
    parser = WallCollectionPreviewArgumentParser(
        description=(
            "Generate the Meckenheim Jungholzweg 2/3 wall collection preview "
...
def main(argv=None):
    ...
    print("")
    print("=" * 70)
    print("ATLAS WALL COLLECTION — MECKENHEIM HOME MEMORY")
    print("=" * 70)
    print("Location            : Jungholzweg 2/3, Meckenheim")
    print("Official building   : Homes at Jungholzweg 2 and 3")
    print("Address             : Jungholzweg 2/3, 53340 Meckenheim")
    print(
        f"Center              : "
