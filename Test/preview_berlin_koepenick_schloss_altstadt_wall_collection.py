...
PBF_PATH = "Data/OSM/berlin-koepenick-schloss-altstadt-test.osm.pbf"

CITY_OUTPUT_PATH = (
    "OUTPUT/STL/"
    "berlin_koepenick_schloss_altstadt_city_150mm.stl"
)

PRODUCT_OUTPUT_PATH = (
    "OUTPUT/STL/"
    "berlin_koepenick_schloss_altstadt_wall_collection_170mm.stl"
)

MULTICOLOR_OUTPUT_DIRECTORY = (
    "OUTPUT/STL/"
    "berlin_koepenick_schloss_altstadt_multicolor"
)

MULTICOLOR_PRODUCT_NAME = (
    "berlin_koepenick_schloss_altstadt_170mm"
)

CENTER_LAT = 52.44465000
CENTER_LON = 13.57425000
...
def build_parser() -> argparse.ArgumentParser:
    parser = WallCollectionPreviewArgumentParser(
        description=(
            "Generate the Berlin Köpenick Schloss and Altstadt wall collection preview "
...
def main(argv=None):
    ...
    print("")
    print("=" * 70)
    print("ATLAS WALL COLLECTION — BERLIN KÖPENICK WATERFRONT MEMORY")
    print("=" * 70)
    print("Location            : Berlin-Köpenick Schlossinsel / Altstadt")
    print("Official building   : Schloss Köpenick")
    print("Address             : Schlossinsel, 12557 Berlin")
    print(
        f"Center              : "
