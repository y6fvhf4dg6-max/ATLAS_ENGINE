...
PBF_PATH = "Data/OSM/korschenbroich-liedberg-test.osm.pbf"

CITY_OUTPUT_PATH = (
    "OUTPUT/STL/"
    "korschenbroich_liedberg_city_150mm_PREMIUM_V1.stl"
)

PRODUCT_OUTPUT_PATH = (
    "OUTPUT/STL/"
    "korschenbroich_liedberg_wall_collection_170mm_PREMIUM_V1.stl"
)

MULTICOLOR_OUTPUT_DIRECTORY = (
    "OUTPUT/STL/"
    "korschenbroich_liedberg_multicolor_PREMIUM_V1"
)

MULTICOLOR_PRODUCT_NAME = (
    "korschenbroich_liedberg_170mm_PREMIUM_V1"
)

CENTER_LAT = 51.16338035
CENTER_LON = 6.54304285
...
def build_parser() -> argparse.ArgumentParser:
    parser = WallCollectionPreviewArgumentParser(
        description=(
            "Generate the Korschenbroich Liedberg wall collection preview "
...
def main(argv=None):
    ...
    print("")
    print("=" * 70)
    print("ATLAS WALL COLLECTION — KORSCHENBROICH LIEDBERG")
    print("=" * 70)
    print("Location            : Liedberg, Korschenbroich")
    print("Official building   : Schloss Liedberg and Mühlenturm")
    print("Address             : Schloßstraße, 41352 Korschenbroich")
    print(
        f"Center              : "
