...
CITY_OUTPUT_PATH = (
    "OUTPUT/STL/"
    "bonn_muensterplatz_city_150mm.stl"
)

PRODUCT_OUTPUT_PATH = (
    "OUTPUT/STL/"
    "bonn_muensterplatz_wall_collection_170mm.stl"
)
...
def build_parser() -> argparse.ArgumentParser:
    parser = WallCollectionPreviewArgumentParser(
        description=(
            "Generate the Bonn Münsterplatz wall collection preview "
...
def main(argv=None):
    ...
    print("")
    print("=" * 70)
    print("ATLAS WALL COLLECTION — BONN BIRTHPLACE MEMORY")
    print("=" * 70)
    print("Location            : Bonn Münsterplatz")
    print("Official building   : Bonner Münster")
    print("Address             : Münsterplatz, 53111 Bonn")
    print(
        f"Center              : "
